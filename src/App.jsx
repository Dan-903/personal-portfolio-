          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-6 text-right">
                <img src="../publicassets/img/daniellatina.png" alt="Daniel-Latina" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-6 col-md-offset-3">
                  <h2>About</h2>
                  <img src="../publicassets/img/lines.svg" className="img-lines" alt="lines" />
                  <p>
                  ...
                  <a
                    href="..../publicassets/CV/DANIEL I. LATINA CV.pdf"
              ...
              <div className="row">
                ...
                <div className="col-sm-6">
                  <div className="service">
                    <img src="../publicassets/img/front-end.svg" alt="Front End Developer" />
                    <h4>Front-end</h4>
                    <p>
                ...
                <div className="col-sm-6">
                  <div className="service">
                    <img src="../publicassets/img/back-end.svg" alt="Back End Developer" />
                    <h4>Back-end</h4>
                    <p>
              ...
              <div className="row">
                <div className="col-md-4 col-sm-10 col-xs-6">
                  <div className="portfolio-item">
                    <img
                      src="../publicassets/img/daniels-coffee.png"
                      className="img-res"
                ...
                <div className="col-md-4 col-sm-10 col-xs-6">
                  <div className="portfolio-item">
                    <img
                      src="../publicassets/img/mock-portfolio.png"
                      className="img-res"
                      alt=""
                    />
                    <div className="portfolio-item-info">
                ...
                <div className="col-md-4 col-sm-10 col-xs-6">
                  <div className="portfolio-item">
                    <img
                      src="../publicassets/img/infograph.png"
                      className="img-res"
                      alt="infograph.png"
                    />
                    <div className="portfolio-item-info">
                ...
                <div className="footer-col">
                  ...
                  <div className="social-links">
                    <a href="https://www.facebook.com/Bopz903/" target="_blank">
                      <img className="icons" src="../publicassets/img/facebook.png" alt="" />
                    </a>
                    <a href="https://github.com/Dan-903" target="_blank">
                    <img className="icons" src="../publicassets/img/github.png" alt="" />
                    </a>
                    <a href="https://www.linkedin.com/in/daniel-latina-b57003278/" target="_blank">
                    <img className="icons" src="../publicassets/img/linkedin.png" alt="" />
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                ...
                <img className="img-res" src="../publicassets/img/Daniels-coffee.png" alt="" />
              </div>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                ...
                <img className="img-res" src="../publicassets/img/mock-portfolio.png" alt="mock-portfolio.png" />
              </div>
              <div className="modal-body">
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                ...
                <img className="img-res" src="../publicassets/img/infograph.png" alt="infograph.png" />
              </div>
              <div className="modal-body">
